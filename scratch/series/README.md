# Scratch Arcade Series — Episode Guide

> **Building eight retro arcade games in Scratch — every Friday on [Cognito Coding](https://www.youtube.com/@CognitoCoding01)**

Each game teaches one headline coding concept. These folders explain what's going on and why. The live Scratch project is linked — grab it, open it, follow at your own pace.

---

## Episodes

| # | Folder | Headline Concept | Video | Scratch Project |
|---|--------|-----------------|-------|-----------------|
| 1 | [ep-01-pong](./ep-01-pong) | Collision detection — the trick behind every game ever made | *(link coming)* | *(link coming)* |
| 2 | [ep-02-snake](./ep-02-snake) | Lists — the data structure that IS the snake | [▶ Watch](https://youtu.be/8qaxgK9FrbM) | [Open in Scratch →](https://scratch.mit.edu/projects/1328679090) |
...
The **[/concepts-a-z](../concepts-a-z)** folder maps individual Scratch blocks to Wednesday Shorts.

*New episode every Friday. [Subscribe →](https://www.youtube.com/@CognitoCoding01)*
