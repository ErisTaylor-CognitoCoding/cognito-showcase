-- file: smart
local want = ... or "minecraft:diamond_ore"  -- type a block name after the file name
local steps = 0                        -- how far he's walked, so he can walk home

print("Hunting for " .. want)          -- say out loud what he's keeping
...
for slot = 1, 16 do                    -- hand over what's left: the block you named
  turtle.select(slot)
  turtle.drop()
end
